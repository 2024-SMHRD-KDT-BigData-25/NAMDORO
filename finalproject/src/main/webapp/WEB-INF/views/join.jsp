...
<head>
    ...
    <style>
        ...
        .login-top{ text-align: center; border-bottom: 1px solid black; 
            font-family: 'Gmarket Sans', sans-serif;
			font-weight: 400;
			font-size: 14px;
			line-height: 20px;
        ...
        .login-box{ text-align: center; height: 600px;}
...
<body>
    ...
    <div class="login-top" >
     ...
     <form action="/boot/users" method="post">
    <div class="square1"></div>
        ...
        <div class="information"> 
            ...
            <div class="input-feild" >
                ...
                <input type="text" class="id" id="user_id" name="user_id"  pattern="^[0-9a-zA-Z]([-_\.]?[0-9a-zA-Z])*@[0-9a-zA-Z]([-_\.]?[0-9a-zA-Z])*\.[a-zA-Z]{2,3}" title="아이디를 확인해 주세요" placeholder="이메일형식으로 입력">
            </div>
            <div class="input-feild" >
                ...
                <input type="text" class="pw" id="user_pw" name="user_pw" placeholder="비밀번호 입력">
            </div>
            <div class="input-feild" >
                <span><img src='data:image/svg+xml;charset=utf-8,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><path d="M224 256A128 128 0 1 0 224 0a128 128 0 1 0 0 256zm-45.7 48C79.8 304 0 383.8 0 482.3C0 498.7 13.3 512 29.7 512l388.6 0c16.4 0 29.7-13.3 29.7-29.7C448 383.8 368.2 304 269.7 304l-91.4 0z"/></svg>' /></span>
                <input type="text" class="name" id="user_name" name="user_name" placeholder="사용자 이름 입력">
            </div>
            <div class="input-feild" >
                ...
                <input type="text" class="nick" id="user_nickname" name="user_nickname" placeholder="닉네임 입력">
            </div>
            <div class="input-feild" >
                ...
                <input type="text" class="phone" id="user_phone" name="user_phone" placeholder="전화번호 입력">
            </div>
        </div>
