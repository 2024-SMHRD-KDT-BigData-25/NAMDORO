    ...
    <div class="square1"></div>
        ...
        <div class="information"> 
            ...
            <div class="input-feild" >
                ...
                <input type="email" class="id" id="user_id" name="user_id"  pattern="^[0-9a-zA-Z]([-_\.]?[0-9a-zA-Z])*@[0-9a-zA-Z]([-_\.]?[0-9a-zA-Z])*\.[a-zA-Z]{2,3}" title="아이디를 확인해 주세요" placeholder="이메일형식으로 입력">
            </div>
            <div class="input-feild" >
