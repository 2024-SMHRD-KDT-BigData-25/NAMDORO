...
<body>
    ...
    String formattedDate = sdf.format(b.getCREATED_AT());
%>
			<div class="board-item">
				<a href="board/<%=b.getTB_NO() %>"
		...
		<%
      if (member == null) { %>
		<button id="writeButton" onclick="location.href='/boot/login'">글
			작성</button>
		<% } else  { %>
		<button id="writeButton"
			onclick="location.href='/boot/board/boardwrite'">글 작성</button>
		<% } %>
	</div>
  ...
  function goToPage(action) {
    ...
    renderBoard(items, totalItems); // 게시글 렌더링
